...
После того как пользователь ввёл 1, 2 или 3, программа будет печатать
соответствующий ответ и завершать цикл с помощью break. Если введены другие
цифры — вопрос будет повторяться в бесконечном цикле. Позапускайте приложение и
поставьте разные оценки, в том числе за пределами требуемого диапазона. Программа будет
снова и снова предлагать вам выбрать только 1, 2 или 3 — это всё заслуга бесконечного цикла.
В этом тренажёре нет правильных ответов — мы добавили его специально, чтобы вы смогли
попробовать, как работает бесконечный цикл с прерыванием break.
 */
package introduction.javaBasics_loops.task11;
