...
Доработайте функционал приложения таким образом, чтобы можно было легко получить список всех расходов
за неделю с разбивкой по дням.
Добавьте в приложение новую команду «4 - Показать траты за неделю».
Напишите новое ветвление для обработки четвёртой команды. Получив её, программа должна выводить
все траты за неделю в формате День _. Потрачено _ рублей.. Нумерация дней должна быть от 1 до 7.
Для печати трат используйте цикл for.
 */
package introduction.javaBasics_array.task14;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                expenses[day - 1] = expenses[day - 1] + expense; // /!\ сохранение значения в массив
