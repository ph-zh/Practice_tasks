...
1/ номер года делится без остатка на 400; или
2/ номер года делится без остатка на 4; и
3/ номер года не делится без остатка на 100.
Результат проверки сохраните в переменную isLeapYear и подставьте в ветвление, которое печатает вывод в
консоли. Сообщение о том, что год не високосный должно стоять в первом блоке кода ветвления.
 */
package javaCore1.primitiveDataTypesAndOperators.task7;
