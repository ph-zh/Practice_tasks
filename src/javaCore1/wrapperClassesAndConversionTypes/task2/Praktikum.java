 ...
 */
package javaCore1.wrapperClassesAndConversionTypes.task2;
...
public class Praktikum {
    public static void main(String[] args) {
        ...
        Resources characterResources = new Resources(inputGold, inputSilver, inputWood, inputHealth, inputHasHelper);
        ...
        Character character = new Character(characterGold, characterSilver, characterWood, characterHealth, characterHelpersNumber);
