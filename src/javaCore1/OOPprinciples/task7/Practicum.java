...
Известно, что:
1/ Система по активации модуля на «Заре» работает неэффективно, что мешает «Звезде» накапливать солнечную энергию.
2/ На станции «ISS» требуется увеличить уровень кислорода и энергетических резервов — сделать это можно только
через подключение «Зари».
3/ Метод стабилизации не срабатывает из-за недостатка топлива. Вместо основного двигателя стоит попробовать
