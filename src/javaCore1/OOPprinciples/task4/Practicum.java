...
Но с программой для тестирования что-то не так — в ней смешались классы из двух разных проектов и пропали все наследственные
связи. Вам нужно отсеять лишние классы и восстановить цепочку наследования. После того, как это будет сделано, проверьте
модификаторы — везде ли обеспечен необходимый уровень доступа!
 */
