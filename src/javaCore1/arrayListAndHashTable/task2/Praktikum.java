...
а также проверять, живёт ли указанное пользователем животное в зоопарке. Вам нужно реализовать следующие
...
4 — Очистить список.
Логика при очистке списка должна быть следующей: если список пуст, то делать ничего не нужно, в обратном
случае — удалить все элементы.
5 — Проверить, есть ли в зоопарке указанное пользователем животное.
 */
package javaCore1.arrayListAndHashTable.task2;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                String animal = scanner.next();
                // Допишите условия
                boolean checkAnimal = animals.contains(animal);
                if (checkAnimal) {
