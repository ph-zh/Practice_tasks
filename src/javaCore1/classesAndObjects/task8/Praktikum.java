/*
В прошлый раз вы описали класс конвертера валют Converter. Дополните код финансового
приложения так, чтобы при запуске программы работала конвертация валют. Для этого потребуется
создать конвертер-объект и вызвать его метод.
 */
package javaCore1.classesAndObjects.task8;
...
public class Praktikum {
    public static void main(String[] args) {
        ...
        Converter сonverter = new Converter(); // Создайте объект класса Converter
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                сonverter.convert(moneyBeforeSalary, currency); // Вызовите метод класса Converter
            } else if (command == 2) {
