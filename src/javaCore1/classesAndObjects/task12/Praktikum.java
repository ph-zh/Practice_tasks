/*
Осталось исправить код в классе Praktikum — конструктор по-умолчанию больше не генерируется и
возникает ошибка. При вызове конструктора с параметрами передайте следующие значения аргуметов: 78.5
для доллара,  для евро и 0.75 для японской иены.
 */
package javaCore1.classesAndObjects.task12;
