/*
Пользователи загрузили в музыкальное приложение большое количество одинаковых треков
под разными названиями. Переопределите метод equals(Object) у класса Song, чтобы можно
было находить одинаковые песни. Вам в помощь в классе Practicum мы реализовали проверку
контракта метода — можете опираться на неё.
 */
